...
export const routeLegs: RouteLeg[] = [
  ...
  { id: "r2b", fromId: "cala-di-volpe", toId: "la-maddalena", mode: "private-car", details: "Transfer to the Palau boat base · 40 min", cost: 150, status: "idea" },
  { id: "r3", fromId: "la-maddalena", toId: "olbia", mode: "private-car", details: "Palau to Olbia airport · 50 min", cost: 200, status: "idea" },
