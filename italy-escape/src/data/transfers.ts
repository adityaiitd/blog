...
export const routeLegs: RouteLeg[] = [
  { id: "r1", fromId: "jfk", toId: "olbia", mode: "international-flight", departure: "20:00", arrival: "12:00", carrier: "", details: "Overnight flight", cost: 0, status: "idea" },
  ...
  { id: "r4", fromId: "olbia", toId: "florence-airport", mode: "internal-flight", details: "Olbia to Florence", cost: 700, status: "idea" },
  ...
  { id: "r10", fromId: "naples-airport", toId: "ewr", mode: "international-flight", details: "Nonstop flight to Newark", cost: 0, status: "idea" },
];
