...
export function ChatPanel() {
  ...
  return (
    <>
      <button onClick={() => setOpen(true)} className="on-ink no-print fixed bottom-5 right-5 z-[1800] flex items-center gap-2 rounded-full bg-[var(--ink)] px-5 py-3 text-sm shadow-2xl" aria-label="Open trip chat"><MessageCircle size={18} />Ask the trip</button>
